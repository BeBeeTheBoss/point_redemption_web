...
export default function Histories() {
    ...
    const exportToExcel = (data, fileName = "export.xlsx") => {
        ...
        const fileNameWithDate = `${fileName.split(".")[0]}-${today}.${
            fileName.split(".")[1]
        }`;
    ...
    const handleFilterHistories = async (month, year, business) => {
        setSelectedMonth(month);
        setSelectedYear(year);
        setSelectedBusiness(business);

        const response = await axios.get(
            "histories/filter?month=" + month + "&year=" + year + "&business=" + business
        );
                ...
                <div className="row">
                    <div className="col-3">
                        <div
                            ...
                            style={{
                                ...
                                borderLeftColor: "#1E43C0",
                                borderLeftWidth: 20,
                            }}
                        >
                            <div className="fw-bold">Total Users</div>
                            <div
                                className="my-1 fw-bold text-[#1E43C0]"
                                style={{ fontSize: "23px" }}
                            >
                                <UserOutlined />{" "}
                    ...
                    <div className="col-3">
                        <div
                            ...
                            style={{
                                backgroundColor: "white",
                                borderLeftColor: "#0A808A",
                                borderLeftWidth: 20,
                            }}
                        >
                            <div className="fw-bold">Redeemed Points</div>
                            <div
                                className="my-1 fw-bold text-[#0A808A]"
                                style={{ fontSize: "23px" }}
                            >
                                <DollarOutlined />{" "}
                    ...
                    <div className="col-3">
                        <div
                            ...
                            style={{
                                backgroundColor: "white",
                                borderLeftColor: "#4f04c0ff",
                                borderLeftWidth: 20,
                            }}
                        >
                            <div className="fw-bold">Active Promotions</div>
                            <div
                                className="my-1 fw-bold text-[#4f04c0ff]"
                                style={{ fontSize: "23px" }}
                            >
                                <ShoppingOutlined />{" "}
                                {props.promotions_count.toLocaleString(
                                    "en-US",
                                    {
                                        minimumFractionDigits: 0,
                                        maximumFractionDigits: 0,
                    ...
                    <div className="col-3">
                        ...
                        >
                            ...
                            <div
                                className="my-1 fw-bold text-[#EA580C]"
                                style={{ fontSize: "23px" }}
                            >
                                <ShopOutlined />{" "}
                    ...
                    <div>
                        <button
                            ...
                            onClick={() =>
                                exportToExcel(
                                    histories,
                                    "point-redemption-report.xlsx"
                                )
                            }
                        >
                            <ExportOutlined className="me-1" /> Export to Excel
                        </button>
                    </div>
                </div>
                <div className="shadow mt-2 mx-2 mb-3">
                    <div
                        className="row p-3 bg-white border"
                        style={{
                    ...
                    {histories.map((history) => (
                        <div className="row p-3 bg-white border mt-3">
                            ...
                            >
                                ...
                                <div className="fw-bold text-[]">
                                    {history.promotion_code}
                                </div>
                            </div>
                            <div className="col-1">x {history.qty}</div>
                            <div className="col-1 fw-bold text-success">
                                {history.redeemed_points}
                            </div>
                            <div className="col-2">
                                {history.business_name}({history.branch_name})
                            </div>
                            <div className="col-2">
