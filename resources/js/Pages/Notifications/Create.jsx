...
export default function Create() {
    ...
    const createNotification = () => {
        ...
        setLoading(true);
        router.post('/notifications/create', form, {
            onError: (errors) => {
            ...
            <AuthenticatedLayout>
                <div className="mt-4">
                    <Breadcrumb
                        items={[
                            ...
                            {
                                title: (
                                    <Link className={`text-decoration-none ${currentRoute == 'create' ? 'text-black fw-bold' : ''}`} href={'/notifications/create'}>
                                        Create
                                    </Link>
                                ),
                            },
                ...
                <div className="flex justify-center items-center" style={{ height: "90vh" }}>
                    <div className="bg-white rounded shadow p-4 border">
                        <div className="fw-bold mt-2 text-theme" style={{ fontSize: "17px" }}>Create new notification</div>

                        <div className="mt-4 row">
                            <div className="col-6">
                                <label htmlFor="">Title</label>
                                <input type="text" className="inputBox" onChange={(e) => setForm({ ...form, title: e.target.value })} />
                            </div>
                            <div className=" col-6">
                        ...
                        <div className="mt-2 row">
                            <div className="col-6">
                                ...
                                <textarea className="inputBoxLarge" rows="10" onChange={(e) => setForm({ ...form, body: e.target.value })}></textarea>
                            </div>
                            <div className=" col-6">
                                ...
                                {imgPreview ?
                                    ...
                                    <div className="imgPreview" style={{ position: "relative" }}>
                                        ...
                                        <button className="btn btn-light btn-sm" style={{ position: "absolute", top: "10px", right: "10px" }} onClick={() => setImgPreview(null)}>X</button>
                                    </div>
                        ...
                        <div className="flex justify-end ">
                            <Button type="dark" className="bg-theme text-white fw-bold h-[37px]" onClick={createNotification}>
                                {loading ? (
